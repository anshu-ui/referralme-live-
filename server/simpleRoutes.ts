        ...
        const prompt =
          mode === "plan"
            ? [
                ...
                intakeLine,
                "",
                "USER: Generate a premium, practical 30-day placement plan.",
                "Constraints:",
                "- Output in clean plain text (no Markdown headings like #, no code fences).",
                "- Include sections: Goal, Current Snapshot, 30-Day Placement Roadmap (Week 1..Week 4 with 4-6 tasks each), Resume/ATS fixes (top 8), Application + networking plan, Interview prep plan, Checkpoints (what to measure).",
